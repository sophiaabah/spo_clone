...
export async function playNewContext(uri) {
  ...
  // context is a JSON object that looks like {"context_uri": "spotify:album:5ht7ItJgpBH7W6vJ5BqpPr"} -- uri property in data.
  return data;
}

// export async function setRepeatMode() {
//   const { data } = await Api().put(`me/player/repeat?state=off`);
